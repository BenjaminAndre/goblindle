<script>
  ...
  import CampaignSearch from "./components/campaign-search.svelte";
  import GameOver from "./components/game-over.svelte";
  import GuessGrid from "./components/guess-grid.svelte";
  import NotePopup from "./components/note-popup.svelte";
  import StatsDisplay from "./components/stats-display.svelte";
...
{:else if game}
  ...
  <CampaignSearch {excludeNames} onSelect={handleGuess} disabled={game.isOver} />
